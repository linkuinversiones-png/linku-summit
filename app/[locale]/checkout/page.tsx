...
const COPY = {
  es: {
    ...
    form: {
      ...
      company: 'Organización o empresa',
      position: 'Cargo',
      linkedin: 'Perfil de LinkedIn',
      linkedinOptional: 'opcional',
      linkedinTooltip:
        'Si nos compartes tu LinkedIn, facilitamos el networking durante los días del evento.',
  ...
  en: {
    ...
    form: {
      ...
      linkedinOptional: 'optional',
      linkedinTooltip:
        'Share your LinkedIn and we will make networking easier during the event days.',
